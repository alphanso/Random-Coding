...
// chefwd.cpp is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.

// chefwd.cpp is distributed in the hope that it will be useful,
...
void solve(ll p)
{
  ull a[] = {1,1,5,3,1,0,0,0,0,0,1,1,0,0,1,0};
  ...
  ull ans = 18*m1[0] + 5*m1[1] + 3*m1[2] + 2*m1[3];
  if(ans >= mod) ans %= mod;
  printf("%lld\n", ans);
}
